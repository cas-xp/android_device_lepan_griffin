...
unzip -j -o $ZIPFILE system/lib/dsp/720p_h264vdec_sn.dll64P -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/dsp/720p_h264venc_sn.dll64P -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/dsp/720p_mp4vdec_sn.dll64P -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/dsp/720p_mp4venc_sn.dll64P -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
# HAL
unzip -j -o $ZIPFILE system/lib/hw/gralloc.omap3.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary

## PVRSGX
unzip -j -o $ZIPFILE system/lib/egl/libEGL_POWERVR_SGX530_125.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/egl/libGLESv1_CM_POWERVR_SGX530_125.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/egl/libGLESv2_POWERVR_SGX530_125.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libsrv_um.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libsrv_init.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libpvr2d.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libpvrANDROID_WSEGL.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libIMGegl.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libglslcompiler.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libusc.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/bin/pvrsrvinit -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOpenVG.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOpenVGU.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary

## OMX 720p libraries
unzip -j -o $ZIPFILE system/lib/libOMX.TI.mp4.splt.Encoder.so  -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOMX.TI.720P.Encoder.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOMX.TI.720P.Decoder.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOMX.ITTIAM.AAC.encode.so  -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOMX.ITTIAM.AAC.decode.so  -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o $ZIPFILE system/lib/libOMX.TI.h264.splt.Encoder.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/cexec.out:/system/bin/cexec.out \\
