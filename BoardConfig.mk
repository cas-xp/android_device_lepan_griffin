...
-include vendor/lepan/griffin/BoardConfigVendor.mk
...
BOARD_CUSTOM_BOOTIMG_MK := device/lepan/griffin/uboot-bootimg.mk
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/lepan/griffin/releasetools/encore_img_from_target_files
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/lepan/griffin/releasetools/encore_ota_from_target_files
...
TARGET_PREBUILT_KERNEL := device/lepan/griffin/prebuilt/boot/kernel

BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_RECOVERY_IGNORE_BOOTABLES := true
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lepan/griffin/recovery/recovery_ui.c
...
BOARD_EGL_CFG := device/lepan/griffin/egl.cfg
